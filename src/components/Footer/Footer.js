          ...
          <div className="col-md-3 mx-auto">
            ...
            <ul className="list-unstyled about-ui">
              <p className="text-start text-capitalize">
                We are always ready to help you, contact us to get any kind of
                information, our team members are always ready to help you with
                any drone.
              </p>
              <ul>
                <li>
          ...
          <div className="col-md-3 mx-auto" style={{ width: "250px" }}>
            ...
            <ul className="list-unstyled text-start contact-ui">
              ...
              <li className="mt-2">
                ...
                <a href="#!">
                  +1232 565 9992 <br /> +1234 333 3434
                </a>
              </li>
